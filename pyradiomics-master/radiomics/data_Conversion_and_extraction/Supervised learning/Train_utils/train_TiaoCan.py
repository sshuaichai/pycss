...
'先定义参数！！！！预处理后的训练集'
data_path = r"D:\zhuomian\pyradiomics\pyradiomics-master\radiomics\data_Conversion_and_extraction\Supervised learning\FeaturesOutput\Data_set_partition\train_0.88_set.csv"
...
encoders_folder = os.path.join(output_folder, "train_tiaocan_encoders")  # Lasso_preprocessing_
model_train_folder = os.path.join(output_folder, "train_tiaocan_models")
visualization_folder = os.path.join(output_folder, "train_tiaocan_visualizations")
