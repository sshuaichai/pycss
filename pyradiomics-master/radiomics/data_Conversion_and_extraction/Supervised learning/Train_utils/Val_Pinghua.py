...
def plot_roc_curve(y_val, y_pred_proba, output_folder):
  ...
  output_path = os.path.join(output_folder, "Val_roc_curve_validation_optimized.tiff")
...
if __name__ == "__main__":
  # 模型和数据集的路径
  model_path = "D:\\zhuomian\\pyradiomics\\pyradiomics-master\\radiomics\\data_Conversion_and_extraction\\Supervised learning\\FeaturesOutput\\Train_Output\\train_models\\LGBMClassifier_model.joblib"
