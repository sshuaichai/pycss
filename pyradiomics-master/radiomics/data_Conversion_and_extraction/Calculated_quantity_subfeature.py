...
# 数据集路径
dataset_path = r"D:\zhuomian\pyradiomics\pyradiomics-master\examples\output\final\radiomics_R3B12_features.csv"
# 输出文件路径
output_path = r"D:\zhuomian\pyradiomics\pyradiomics-master\examples\output\calculated\fina_R3B12_SubfeatureCounts.csv"
