...
# 提取的影像组学特征文件路径
features_file_path = r"D:\zhuomian\pyradiomics\pyradiomics-master\examples\output\Voxel_feature_R1B12.csv"
# 输出CSV文件路径
output_csv_path = r"D:\zhuomian\pyradiomics\pyradiomics-master\examples\output\calculated\Voxel_R1B12_ClassCounts.csv"#过滤器/原始特征
